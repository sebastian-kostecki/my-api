...
class CodeGenerator extends AbstractAction implements ActionInterface
{
    use ShouldThread;
    ...
    private const INSTRUCTIONS = "You are a highly skilled AI specialized in generating accurate and efficient programming code. Your task is to understand the user's requirements and produce the corresponding code in the specified programming language. Follow these guidelines:\n"
