        ...
        <div class="row about-me-content">
            ...
            <div class="col">
                <p>Z pasją podchodzę do swoich zadań. Staram się w pełni zrozumieć oczekiwania klienta, aby następnie
                    tworzyć wysokiej jakości produkty końcowe. Poza pracą skupiam się głównie na czasie z rodziną oraz
        ...
        <div class="container py-5">
            ...
            <div class="row border-bottom border-secondary">
                ...
                <div class="col-8 d-flex align-items-center">
                    <p>Pracuję głównie w języku <strong>PHP</strong> korzystając z frameworku <strong>Laravel</strong>.
            ...
            <div class="row border-bottom border-secondary pt-3">
                ...
                <div class="col-8 d-flex align-items-center">
                    <p>W pracy wykorzystuję framework <strong>Vue.js</strong> w wersji 2. Obecnie poznaję wersję 3.</p>
                </div>
            </div>
            <div class="row border-bottom border-secondary pt-3">
                <div class="col-2 d-flex flex-column">
            ...
            <div class="row pt-3">
                ...
                <div class="col-2 d-flex flex-column">
                    <svg role="img" viewBox="0 0 24 24" height="64" xmlns="http://www.w3.org/2000/svg"><title>PhpStorm</title>
                        <path
                ...
                <div class="col-8 d-flex align-items-center">
                    <p>Posługuję się systemem kontroli wersji <strong>GIT</strong> oraz moim środowiskiem programistycznym jest <strong>PHP Storm</strong>.</p>
                </div>
            </div>
